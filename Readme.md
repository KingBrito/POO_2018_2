# Meu projeto King Brito - O rei do projeto
...
## 08_Repositorio 1
### 01-O que você fez ?
 -Fiz a pratica Repositorio com todos os requisitos pedidos. Com as classes Repositorio{...} servindo como a parte que ira gerenciar as outras classes;Aluno{...} que representará o aluno; Professor{...} que representará como professor; Disciplina{...} que representará como as disciplinas; Datacenter{...} onde como o nome já diz irá guardar todos os alunos,professores e disciplina;
### 02-Com quem e como você fez ?
 -Fiz sozinho. IMplementei o codigo do repositorio feito em aula,sem mudanças, no Datacenter{...} achei melhor usar o map já que é mais simples e util para esse trabalho.
### 03-O que aprendeu e sabe fazer ? 
 -A manusear template, a implementar operator(magica) e map
### 04-O que tem dificuldade ainda ?
 -Nessa pratica tive algumas duvidas em como extrair informações do stringstream, mas nada que só uma revisada nas aulas do youtube não resolva.
### 05-Quanto tempo levou pra fazer a atividade 
 -Em media 4hrs, duas horas em dois dias
  
## 09_Anotações
### 01-O que você fez ?
  -Fiz o trabalho completo. Com as classes Nota{...} que representará as notas; Usuario{...} que representará as notas; Sistema{...} que irá guardar os usuarios; GerLogin{...} que representará o sistema de login e Master{...} que possui os comandos.
### 02-Com quem e como você fez ?
  -Fiz sozinho.
### 03-O que aprendeu e sabe fazer ? 
  -Aprendi o sistema de login 
### 04-O que tem dificuldade ainda ?
  -Tentei implementar com a lista porém usei vector.
### 05-Quanto tempo levou pra fazer a atividade 
  -Levei em média 5hrs.
